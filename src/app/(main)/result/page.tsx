                  ...
                  <TableBody>
                    {results?.semesters?.map((semester) => (
                      <TableRow key={semester.sl}>
                        ...
                        <TableCell>
                          {semester.creditProbation.toFixed(2)}
                        </TableCell>
                        <TableCell>
                          {semester.termGPAProbation.toFixed(2)}
                        </TableCell>
                        <TableCell>
                          {semester.cgpaProbation.toFixed(2)}
                        </TableCell>
                        <TableCell>
                          {semester.creditTranscript.toFixed(2)}
                        </TableCell>
                        <TableCell>
                          {semester.gpaTranscript.toFixed(2)}
                        </TableCell>
                        <TableCell>
                          {semester.cgpaTranscript.toFixed(2)}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
